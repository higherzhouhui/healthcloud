            ...
            <view class="form-box">
                <view class="uni-form-item uni-column">
                    ...
                    <view class="input-box">
                        <input class="uni-input" v-model="form.name" placeholder="请输入兑换金额" />
                        <image v-if="form.name" src="../../../static/login/close.png" class="clear" @tap="() => form.name = ''"></image>
                    </view>
                </view>
                <view class="amount">可用数字人民币：{{ amount }} 万</view>
            </view>
    ...
    <form>
        <view class="form-box">
            <view class="uni-form-item uni-column">
                ...
                <view class="input-box">
                    <input class="uni-input" v-model="form.name" placeholder="请输入收款账户" />
                    <image v-if="form.name" src="../../../static/login/close.png" class="clear" @tap="() => form.name = ''"></image>
                </view>
            </view>
        </view>
        ...
        <view class="form-box">
            <view class="uni-form-item uni-column">
                ...
                <view class="input-box">
                    <input class="uni-input" v-model="form.name" placeholder="请输入银行支行" />
                    <image v-if="form.name" src="../../../static/login/close.png" class="clear" @tap="() => form.name = ''"></image>
                </view>
            </view>
        </view>
        <view class="form-box">
            <view class="uni-form-item uni-column">
                ...
                <view class="input-box">
                    <input class="uni-input" v-model="form.name" placeholder="请输入联络电话" />
                    <image v-if="form.name" src="../../../static/login/close.png" class="clear" @tap="() => form.name = ''"></image>
                </view>
            </view>
        </view>
